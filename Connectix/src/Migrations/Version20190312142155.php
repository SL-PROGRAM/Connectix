 ...
 */
final class Version20190312142155 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reseach_order (id INT AUTO_INCREMENT NOT NULL, socity_id INT NOT NULL, product_id INT NOT NULL, reseach_do INT NOT NULL, research_activity_cost INT NOT NULL, administration_activity_cost INT NOT NULL, INDEX IDX_56D58109302CE478 (socity_id), UNIQUE INDEX UNIQ_56D581094584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
